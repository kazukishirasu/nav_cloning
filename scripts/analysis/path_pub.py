...
class Simple_path_simulator():
    ...
    def __init__(self):
        ...
        self.csv_path_data = pd.read_csv("/home/kazuki/catkin_ws/src/nav_cloning/data/result_use_dl_output/test/path_pub.csv")
    ...
    def get_poses_from_csvdata(self):
        ...
        for indx in range(len(self.csv_path_data)):
            ...
            temp_pose.pose.position.x = self.csv_path_data["x"][indx] - 11.0173539
            temp_pose.pose.position.y = self.csv_path_data["y"][indx] - 16.7566943
