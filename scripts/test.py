...
class nav_cloning_node:
    def __init__(self):
        ...
        self.load_path = roslib.packages.get_pkg_dir('nav_cloning') + '/data/model_'+str(self.mode)+'/model'
        ...
        self.img_path = roslib.packages.get_pkg_dir('nav_cloning') + '/data/result_image/model'
        ...
        self.count = 0
        self.flag = False
        self.dl.load(self.load_path + str(self.model_num) + '.net')
    ...
    def callback_srv(self, data):
        ...
        cv2.imwrite(self.img_path + str(self.model_num) + '.png', self.crop_img)
        return resp
